    ...
    public partial class nit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Dành cho đường núi", "Xe đạp địa hình" });

            migrationBuilder.InsertData(
                table: "categories",
                columns: new[] { "CategoryId", "Description", "Name" },
                values: new object[] { 2, "Dành cho đường bằng", "Xe đạp đường phố" });

            migrationBuilder.InsertData(
                table: "categories",
                columns: new[] { "CategoryId", "Description", "Name" },
                values: new object[] { 3, "Dành cho trẻ em", "Xe đạp trẻ em" });
